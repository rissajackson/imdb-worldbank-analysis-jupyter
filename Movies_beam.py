...
class AddCurrencyFn(beam.DoFn):
  def process(self, element):
    ...
    new_results = {"imdb_title_id":imdb_title_id,"title":title,"original_title":original_title,"year":year,"genre":genre,"duration":duration,"country":country,"language":language,"director":director,"writer":writer,"production_company":production_company,"actors":actors,"description":description,"avg_votes":avg_votes,"votes":votes,"budget_currency":bg_curr,"budget":bg_budget,"usa_gross_income":new_usa_income,"worlwide_gross_income_currency":worl_currency,"worlwide_gross_income":new_worl_income,"metascore":metascore,"reviews_from_users":reviews_from_users,"reviews_from_critics":reviews_from_critics}
    return [new_results]
