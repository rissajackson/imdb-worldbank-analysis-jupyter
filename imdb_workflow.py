...
with models.DAG(
    ...
    branch >> load_movies >> create_movies >> dataflow_movies >> dataflow_new_movies
    branch >> load_ratings >> create_ratings
    branch >> load_title_principals >> load_names >> create_actors >> create_directors >> create_writers >> create_actors_movie >> create_directors_movie >> create_writers_movie >> dataflow_directors >> dataflow_writers >> dataflow_actors